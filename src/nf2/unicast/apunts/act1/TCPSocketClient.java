...
//que ho sigui ens preparem per sortir del bucle
    ...
    private String getRequest(String serverData) {
        ...
        System.out.println("Resposta del servidor: " + serverData);
        System.out.print("Introdueix la teva petició (escriu 'exit' per sortir): ");
        return scanner.nextLine();
    }

    private boolean mustFinish(String request) {
        return request != null && request.equalsIgnoreCase("exit");
    }
